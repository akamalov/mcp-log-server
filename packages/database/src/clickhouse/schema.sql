...
TTL toDateTime(timestamp) + INTERVAL 90 DAY DELETE -- Auto-delete logs older than 90 days
...
TTL toDateTime(timestamp) + INTERVAL 30 DAY DELETE -- Keep metrics for 30 days
SETTINGS index_granularity = 8192;
